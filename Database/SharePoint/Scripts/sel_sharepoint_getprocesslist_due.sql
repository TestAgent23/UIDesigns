...
/* block 5 — table + database for a sharepoint process by process name */
declare @processNameLookup nvarchar(255) = 'PUT-PROCESS-NAME-HERE';
...
/* block 6 — force one config due: set @id from block 3/4, paste block 1 into @utc/@end, run matching update only */

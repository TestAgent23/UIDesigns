...
namespace Teleperformance.DataIngestion.API.Controllers.v1._0
{
    ...
    public class ProcessConfigurationController : ControllerBase
    {
        ...
        [Route("GetSharePointSourceByConfigId")]
        [HttpGet]
        public async Task<IActionResult> GetSharePointSourceByConfigId(string configurationId)
        { var result = await _processConfigurationService.GetSharePointSourceByConfigId(configurationId); return StatusCode(result.ResponseCode, result); }
        #endregion

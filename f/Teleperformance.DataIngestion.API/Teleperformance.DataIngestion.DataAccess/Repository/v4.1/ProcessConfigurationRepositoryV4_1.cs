    ...
    public class ProcessConfigurationRepositoryV4_1 : IProcessConfigurationRepositoryV4_1
    {
        ...
        public async Task<int> InsertProcessRuleSet(RuleSetEntity ruleSet, string tabName, string securityGroupIds, string created_by, string username, string description)
        {
            try
            {
                ...
                dynamicParameters.Add("@ruleDbColumnName", ruleSet.ruleDbColumnNames != null ? string.Join(",", ruleSet.ruleDbColumnNames) : null);
                dynamicParameters.Add("@ruleDbColumnName2", ruleSet.ruleDbColumnNames2 != null ? string.Join(",", ruleSet.ruleDbColumnNames2) : null);
                dynamicParameters.Add("@ruleDescription", ruleSet.ruleDescription);
                dynamicParameters.Add("@prompt", ruleSet.prompt);
                dynamicParameters.Add("@promptUsingDBColumnName", ruleSet.promptUsingDBColumnName);
        ...
        public async Task<bool> GetWorkspaceConnectAccess(string securityGroupId)
        {
            var dynamicParameters = new DynamicParameters();
            dynamicParameters.Add("@securityGroupId", securityGroupId);
            return await _dapperService.GetSingleRowAsync<bool>("[sel_workspaceConnectAccess]", dynamicParameters, commandType: CommandType.StoredProcedure);
        }
        #endregion
        ...
        public async Task<bool> InsertRegex(List<LandingLayerRegex> regex, string flpConfigurationId, string loginId)
        {
            ...
            var cleaned = regex?
                    .Select(r => new LandingLayerRegex { regex = r.regex?.Trim(), description = r.description?.Trim(), mode = r.mode })
        ...
        public async Task<IEnumerable<TempFileDetailsForDelete>> GetTempFileDetailsAsync()
        {
           var dbResult =  await _dapperService.GetMultipleRowsAsync<TempFileDetailsForDelete>("[sel_tempFileDetailsByFlpConfigurationId]", null, CommandType.StoredProcedure);
           return dbResult;
        }


        public async Task<DatabaseResponse> UpdateFlagDeletedTempFileAsync(string flpConfigurationId, string uploadFileId, bool isDeletedTempFile)
        {
            var parameters = new DynamicParameters();
            parameters.Add("flpConfigurationId", flpConfigurationId, DbType.String);
            parameters.Add("fileUploadedId", uploadFileId, DbType.String);
            parameters.Add("isDeletedTempFile", isDeletedTempFile, DbType.String);
            var dbResponse = await _dapperService.GetSingleRowAsync<DatabaseResponse>("[commit_updateIsDeletedTempFileFlag]", parameters, commandType: CommandType.StoredProcedure);
            return dbResponse;
        }



        public async Task<DatabaseResponse> BulkUpdateCampaignUserAccessByGeoMapping(
    int? regionId, string? subRegionId, int? clientId, string? applicationId, List<string> upnList)
        {
            try
            {
                var dynamicParameters = new DynamicParameters();
                ...
                dynamicParameters.Add("@clientId", clientId);
                dynamicParameters.Add("@applicationId", applicationId);
                dynamicParameters.Add("@upnList", BuildUpnDataTable(upnList).AsTableValuedParameter("UpnListTVP"));

                return await _dapperService.GetSingleRowAsync<DatabaseResponse>(
                    "[commit_bulkUpdateCampaignUserAccessByGeoMapping]",
                    dynamicParameters,
                    commandType: CommandType.StoredProcedure);
            }
            catch (Exception ex)
        ...
        public async Task<DatabaseResponse> BulkDeleteCampaignUserAccessByGeoMapping(
            int? regionId, string? subRegionId, int? clientId, string? applicationId, List<string> upnList)
        {
            try
            {
                ...
                return await _dapperService.GetSingleRowAsync<DatabaseResponse>(
                    "[commit_bulkDeleteCampaignUserAccessByGeoMapping]",
                    dynamicParameters,
                    commandType: CommandType.StoredProcedure);
            }
            catch (Exception ex)
        ...
        public async Task<DatabaseResponse> BulkUpdateCampaignUserAccessSuperAdmin(string applicationId, List<string> upnList)
        {
            try
            {
                var dynamicParameters = new DynamicParameters();
                ...
                return await _dapperService.GetSingleRowAsync<DatabaseResponse>(
                    "[commit_bulkUpdateCampaignUserAccessSuperAdmin]",
                    dynamicParameters,
                    commandType: CommandType.StoredProcedure);
            }
            catch (Exception ex)
        ...
        public async Task<DatabaseResponse> BulkDeleteCampaignUserAccessSuperAdmin(string applicationId, List<string> upnList)
        {
            try
            {
                var dynamicParameters = new DynamicParameters();
                ...
                return await _dapperService.GetSingleRowAsync<DatabaseResponse>(
                    "[commit_bulkDeleteCampaignUserAccessSuperAdmin]",
                    dynamicParameters,
                    commandType: CommandType.StoredProcedure);
            }
            catch (Exception ex)
        ...
        // NOTE: BuildUpnDataTable already exists from the previous BulkUpdateCampaignUserAccessByGeoMapping step
        // private static DataTable BuildUpnDataTable(List<string> upnList) { ... }

        // Shared helper — builds DataTable matching UpnListTVP type
        private static DataTable BuildUpnDataTable(List<string> upnList)
        {
            var dataTable = new DataTable();
            dataTable.Columns.Add("Upn", typeof(string));
            foreach (var upn in upnList)
                dataTable.Rows.Add(upn);
            return dataTable;
        }
    }
}

...
namespace Teleperformance.DataIngestion.DataAccess.Repository.v1._0
{
    public class ProcessConfigurationRepository : IProcessConfigurationRepository
    {
        ...
        public async Task<FlpSharePointSourceDetail?> GetSharePointSourceByConfigId(string flpConfigurationId)
        {
            ...
            return await _dapperService.GetSingleRowAsync<FlpSharePointSourceDetail>("dbo.sel_flpSharePointSourceByConfigId", parameters, commandType: CommandType.StoredProcedure);
        }
        #endregion

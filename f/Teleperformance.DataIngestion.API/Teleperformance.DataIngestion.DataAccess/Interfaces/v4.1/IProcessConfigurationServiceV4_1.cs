...
namespace Teleperformance.DataIngestion.DataAccess.Interfaces.v4._1
{
    public interface IProcessConfigurationServiceV4_1
    {
        ...
        Task<APIResponse<ConfigurationAPISourceResponseDto>> InsertNewAPISource(InsertNewApiSourceRequest request);
        ...
        Task<APIResponse<bool>> GetWorkspaceConnectAccess();
        #endregion

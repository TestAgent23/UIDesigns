...
namespace Teleperformance.DataIngestion.DataAccess.Interfaces.v4._1
{
    public interface IProcessConfigurationRepositoryV4_1
    {
        ...
        Task<bool> GetWorkspaceConnectAccess(string securityGroupId);
        #endregion
        ...
        #region temp file details for delete
        Task<IEnumerable<TempFileDetailsForDelete>> GetTempFileDetailsAsync();
        Task<DatabaseResponse> UpdateFlagDeletedTempFileAsync(string flpConfigurationId, string uploadFileId, bool isDeletedTempFile);
        #endregion

        Task<DatabaseResponse> BulkUpdateCampaignUserAccessByGeoMapping(int? regionId, string? subRegionId, int? clientId, string? applicationId, List<string> upnList);
        Task<DatabaseResponse> BulkDeleteCampaignUserAccessByGeoMapping(int? regionId, string? subRegionId, int? clientId, string? applicationId, List<string> upnList);
        Task<DatabaseResponse> BulkUpdateCampaignUserAccessSuperAdmin(string applicationId, List<string> upnList);
        Task<DatabaseResponse> BulkDeleteCampaignUserAccessSuperAdmin(string applicationId, List<string> upnList);

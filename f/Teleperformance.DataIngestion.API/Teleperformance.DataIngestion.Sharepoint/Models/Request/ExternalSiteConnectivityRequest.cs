...
public sealed class ExternalSiteConnectivityRequest
{
    ...
    /// <summary>SharePoint host to probe (e.g. teleperformance.sharepoint.com). Required when using Microsoft Entra credentials below; otherwise the internal app's host is used.</summary>

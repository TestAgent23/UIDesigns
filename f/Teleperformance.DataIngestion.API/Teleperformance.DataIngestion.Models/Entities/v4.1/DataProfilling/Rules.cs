...
namespace Teleperformance.DataIngestion.Models.Entities.v4._1.DataProfilling
{
    ...
    public class RuleSet
    {
        ...
        private string _ruleDbColumnNamesRaw;
        public string[] ruleColumnName => _ruleColumnNameRaw?.Split(',') ?? Array.Empty<string>();
        public string[] ruleDbColumnNames => _ruleDbColumnNamesRaw?.Split(',') ?? Array.Empty<string>();
        ...
        public string ruleDbColumnNameRaw
        {
            get => _ruleDbColumnNamesRaw;
            set => _ruleDbColumnNamesRaw = value;
        }

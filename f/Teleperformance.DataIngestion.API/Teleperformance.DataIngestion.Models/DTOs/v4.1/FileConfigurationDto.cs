...
namespace Teleperformance.DataIngestion.Models.DTOs.v4._1
{
    ...
    public class RuleSet
    {
        ...
        public string[] ruleDbColumnNames { get; set; }
        public string ruleDbColumnNames2 { get; set; }
        public string ruleDescription { get; set; }

        public string prompt { get; set; }
        public string promptUsingDBColumnName { get; set; }
    ...
    public class InsertNewApiSourceRequest
    {
        public APISource apiSource { get; set; }
       
        public FileConfigurationDto config { get; set; }
    ...
    public class APISource
    {
        public string flpConfigurationId { get; set; }
        public string exportJSON { get; set; }
        public DrawFlowProperties[] nodeProperties { get; set; }
    }
    public class DrawFlowProperties
    {
        public int id { get; set; }
        public string name { get; set; }
        public string httpMethod { get; set; }
        public string stringURL { get; set; }
        public APIUPloadParams[] nodeParams { get; set; }
        public APIUPloadParams[] headers { get; set; }
        public RequestBody body { get; set; }
        public APIAuthorization authorization { get; set; }
        public APISelectedResponse[] selectedResponses { get; set; }
    ...
    {
        public bool willInclude { get; set; }
    ...
    public class APISelectedResponse
    {
    ...
    {
        public APIUPloadParams[] formData { get; set; }
        public APIUPloadParams[] xWWWFormUrlEncoded { get; set; }

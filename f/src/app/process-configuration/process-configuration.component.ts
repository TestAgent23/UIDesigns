...
import { Component, ElementRef, EventEmitter, Input, OnInit, OnChanges, Output, SimpleChanges, ViewChild, ChangeDetectionStrategy, IterableDiffers, DoCheck } from '@angular/core';

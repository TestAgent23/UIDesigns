...
import { SHAREPOINT_ENV, type SharepointUserConfig } from '../core/workspace-connect.types';
import { SP_API, SP_USER_AUTH } from '../core/workspace-connect.messages';
import { ApiEnvelope, ApplicationDto, MeDrivesDiscoveryReportDto, SharePointItemDto, UserBrowseRequest, UserConnectSiteRequest, UserConnectSiteResultDto, UserFileRequest } from '../core/workspace-connect.types';
import { decodeJwtPayload, encodePath64, logMeDrivesDiagnostics, unwrapApiEnvelope } from '../core/workspace-connect.utils';

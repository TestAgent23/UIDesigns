...
import { AccountInfo, AuthenticationResult, InteractionStatus, PopupRequest, RedirectRequest } from '@azure/msal-browser';
...
export class AuthService {
  ...
  getWorkspaceConnectAccess() {
    const headers: HttpHeaders = this.setHttpsRequestHeaders('4.1');
    const url = this.baseUrl + 'api/ProcessConfiguration/GetWorkspaceConnectAccess';
    return this.http.get<APIResponse<boolean>>(url, { headers });
  }

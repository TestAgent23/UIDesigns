...
const GUEST_DS_CONFIG = {
  consumerApplicationId: '3452f3ba-af59-41c5-85a0-11df12404adc',
  sourceDataObjId: '86176C0E-5791-4603-B6ED-412CCC14F165',
};
...
export function resolveGuestMock(req: HttpRequest<unknown>): unknown | 'GRAPH_PHOTO' | null {
  ...
  if (url.includes('getworkspaceconnectaccess')) {
    return guestOk(true);
  }
    ...
    return guestOk([
      {
        ...
        databaseServer: 'sql-staging-01.database.windows.net',
        defaultDB: true,
        groupBy: 'Default',
      },
      {
        ...
        databaseServer: 'sql-master-01.database.windows.net',
        defaultDB: false,
        groupBy: 'Exclusive',
      },
    ]);
  ...
  if (url.includes('insertflpconfigurationdetails')) {
    return null;
  }

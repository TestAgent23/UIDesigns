...
export interface AdditionalSettings extends RuleSetAdditionalSettings, LandingLayerFormValues, DisplayNamesOnly {
...
interface DisplayNamesOnly{
  deltaStorageAccountIdDisplayName : string;
  databaseNameDisplayName : string;
}

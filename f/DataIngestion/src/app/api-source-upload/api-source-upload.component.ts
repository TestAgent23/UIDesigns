          ...
          if (nodeType) {
            ...
            this.nodeProperties.push({
              ...
              headers: [
                ...
                { willInclude: true, key: 'userid', value: sessionStorage.getItem('upn') ?? '', description: '', prefix: '' },
                { willInclude: true, key: 'clientid', value: environment.appId, description: '', prefix: '' },
                { willInclude: true, key: 'clientsecret', value: environment.clientKey, description: '', prefix: '' },

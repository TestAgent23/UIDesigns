import type { ProcessConfigSharePointSelection } from '../core/workspace-connect.types';
import { PROCESS_TYPE_SHAREPOINT_WORKSPACE } from '../core/workspace-connect.types';

  ...
  onDataSource(event: number) {
    switch (event) {
      ...
      case 3:
        ...
        break;
      case 4:
        this.navigateService.dataSource = DataSourceType.APISource;
        this.router.navigate(['/api-source']);  
        return;
  ...
  onConfiguration(event: number) {
    switch (event) {
      ...
      case 3:
        ...
        break;
      case 4:
        this.navigateService.configurationProcess = DataSourceType.APISource;
        break;
    }

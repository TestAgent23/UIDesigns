...
public interface ISharePointPluginService
{
    ...
    Task<IReadOnlyList<Application>> GetApplicationsAsync(string? ownerKey, string? typeCode, int? regionIdent, string? subRegionCode, int? clientIdent, Guid? securityGroupId, bool includeInactive = false);

...
public interface ISharePointPluginRepository
{
    ...
    Task<IReadOnlyList<Application>> GetApplicationsAsync(string? ownerKey, int? typeId, int? regionIdent, string? subRegionCode, int? clientIdent, Guid? securityGroupId, bool includeInactive = false);

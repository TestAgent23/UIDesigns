    ...
    public class FlpConfigurationHelper
    {
        ...
        public static string GetFileLocation(FlpConfigurationResponseDto flpConfigurationRequestDto)
        {
            ...
            if ((int)SourceLocationTypeEnum.SharePoint == flpConfigurationRequestDto.LocationTypeId)
            {
                ...
                if (!string.IsNullOrWhiteSpace(sharePointFileUrl))
                    return sharePointFileUrl;
                return flpConfigurationRequestDto.SourcePath ?? string.Empty;
            }
            #endregion
            return "";
        }
       ...
       BlobClient csvBlobClient,ISMBLibraryServices ismbLibraryServices)
        ...
        public static string GetUploadedFileId(FlpRequestDto flpRequestDto)
        {
            ...
            {
                return flpRequestDto.BlobClients.UploadedId ?? string.Empty;
            }

            if (flpRequestDto.SharePointFileLocation != null)
            {
                return flpRequestDto.SharePointFileLocation.UploadedId ?? string.Empty;
            }

            return flpRequestDto.OnPremFileLocation?.UploadedId ?? string.Empty;
        }

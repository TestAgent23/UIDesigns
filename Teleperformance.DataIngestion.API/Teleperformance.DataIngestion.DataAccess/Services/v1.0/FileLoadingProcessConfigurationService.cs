    ...
    public class FileLoadingProcessConfigurationService : IFileLoadingProcessConfiguration
    {
            ...
            int processTypeId)
        {
            ...
            try
            {
                ...
                // SharePoint: every file currently in the source folder should be returned.
                // Do not call sel_checkUploadedFileStatus here — after the first GetProcessList,
                // that SP blocks the same filename even when the file is still in SharePoint
                // (e.g. ingest/move failed or was never run). Folder browse is the source of truth.

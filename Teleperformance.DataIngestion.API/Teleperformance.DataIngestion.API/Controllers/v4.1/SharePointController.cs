...
public sealed class SharePointController : ControllerBase
{
    ...
    public async Task<IActionResult> GetApplications(
        ...
        [FromQuery] int? regionIdent,
        [FromQuery] string? subRegionCode,
        [FromQuery] int? clientIdent,
        [FromQuery] Guid? securityGroupId,
        [FromQuery] bool includeInactive = false)
    {
        var apps = await _sharePointService
            .GetApplicationsAsync(ownerKey, typeCode, regionIdent, subRegionCode, clientIdent, securityGroupId, includeInactive)

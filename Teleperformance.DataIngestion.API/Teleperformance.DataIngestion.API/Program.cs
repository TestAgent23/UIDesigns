...
try
{
    ...
    if (useLocalEnvironment)
    {
        ...
        decryptedConnectionString =
            "Server=.;Database=SharepointPlugin;Trusted_Connection=True;TrustServerCertificate=True;";
        ...
        Environment.SetEnvironmentVariable("sharepointinternaltenantid", "6");
        ...
        Environment.SetEnvironmentVariable("sharepointinternalhostname", "nocompany102.sharepoint.com");
